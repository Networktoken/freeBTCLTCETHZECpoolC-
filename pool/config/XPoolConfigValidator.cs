...
namespace XPool.config
{
    ...
    public class WebhookNotificationsConfigValidator : AbstractValidator<WebhookNotifcations>
    {
        public WebhookNotificationsConfigValidator()
        {
    ...
    public class ClusterConfigValidator : AbstractValidator<XPoolConfig>
    {
    ...
    [Validator(typeof(WebhookNotificationsConfigValidator))]
